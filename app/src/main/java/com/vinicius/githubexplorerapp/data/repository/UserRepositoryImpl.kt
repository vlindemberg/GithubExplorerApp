...
class UserRepositoryImpl @Inject constructor(
    ...
    override suspend fun getUserFollowers(token: String, username: String): List<UserFollower> =
        userRemoteDataSource.getUserFollowers(token, username).toUserFollowers()
}